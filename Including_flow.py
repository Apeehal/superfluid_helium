...
def v_n(nodes, dt):
    ...
    for x in range(1,num_nodes_x-1):
        ...
        v_s_x_bottom = ((-density_superfluid*entropy*grad_T_x[0][x] - (density_normal/total_density)*grad_P_x[0][x] + (viscosity*laplacian_bottom)/(dy**2))*dt)/density_normal
        nodes[0][x].v_s = (v_s_x_bottom)
    ...
    for x in range(1,num_nodes_x-1):
        ...
        v_s_x_top = ((-density_superfluid*entropy*grad_T_x[num_nodes_y-1][x] - (density_normal/total_density)*grad_P_x[num_nodes_y-1][x] + (viscosity*laplacian_top)/(dy**2))*dt)/density_normal
        nodes[num_nodes_y-1][x].v_s = (v_s_x_top)
    ...
    for y in range(num_nodes_y):
        for x in range(num_nodes_x):
            ...
            if x==0 and y==0:
                ...
                v_s_x_bottom_left = ((-density_superfluid*entropy*grad_T_x[0][0] - (density_normal/total_density)*grad_P_x[0][0] + (viscosity*laplacian_bottom_left)/(dy**2))*dt)/density_normal
                nodes[0][0].v_s = (v_s_x_bottom_left)
            ...
            if x==0 and y==num_nodes_y-1:
                ...
                v_s_x_top_left = ((-density_superfluid*entropy*grad_T_x[num_nodes_y-1][0] - (density_normal/total_density)*grad_P_x[num_nodes_y-1][0] + (viscosity*laplacian_top_left)/(dy**2))*dt)/density_normal
                nodes[0][num_nodes_y-1].v_s = (v_s_x_top_left)
            ...
            if x==num_nodes_x-1 and y==0:
                ...
                v_s_x_bottom_right = ((-density_superfluid*entropy*grad_T_x[0][num_nodes_x-1] - (density_normal/total_density)*grad_P_x[0][num_nodes_x-1] + (viscosity*laplacian_bottom_right)/(dy**2))*dt)/density_normal
                nodes[0][0].v_s = (v_s_x_bottom_right)
            ...
            if x==num_nodes_x-1 and y==num_nodes_y-1:
                ...
                v_s_x_top_right = ((-density_superfluid*entropy*grad_T_x[num_nodes_y-1][num_nodes_x-1] - (density_normal/total_density)*grad_P_x[num_nodes_y-1][num_nodes_x-1] + (viscosity*laplacian_top_right)/(dy**2))*dt)/density_normal
                nodes[0][0].v_s = (v_s_x_top_right)
